...
public class GameState {
    ...
    public GameState(ArrayList<BoardCard> cards, ArrayList<BoardCard> goldNuggetCards, Board board, ArrayList<Player> players, Integer minerCount, Integer saboteurCount) {
        this.cards = cards;
